...
void Player::createAnimations() {
    ...
    addAnimation(ATTACK_UP_LEFT, BASIC_MELEE_ATTACK_SHEET, 2, 10);
    addAnimation(ATTACK_UP, BASIC_MELEE_ATTACK_SHEET, 2, 10, false);
    addAnimation(ATTACK_UP_RIGHT, BASIC_MELEE_ATTACK_SHEET, 2, 10);
    addAnimation(ATTACK_RIGHT, BASIC_MELEE_ATTACK_SHEET, 2, 10);
    addAnimation(ATTACK_DOWN_RIGHT, BASIC_MELEE_ATTACK_SHEET, 2, 10);
    addAnimation(ATTACK_DOWN, BASIC_MELEE_ATTACK_SHEET, 2, 10);
    addAnimation(ATTACK_DOWN_LEFT, BASIC_MELEE_ATTACK_SHEET, 2, 10);
    addAnimation(ATTACK_LEFT, BASIC_MELEE_ATTACK_SHEET, 2, 10);
}
